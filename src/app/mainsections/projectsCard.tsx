        ...
        <div>
            <div className="flex flex-wrap justify-center justify-items-center gap-5">
                ...
                {items.map((item, idx) => (
                    ...
                    <div className={`${styles.imgclass} max-w-[20rem] aspect-[7/4] bg-[url(${item?.imageurl})] rounded-xl`} >
                    ...
                    <div className={`flex justify-end justify-items-end gap-4 py-2`}>
                        ...
                        <Link
                            href={item?.livelink}
                            key={item?.livelink}
                            className="flex px-[1rem] bg-[#010B0E] py-[0.5rem] rounded-lg"  
                            target="_blank"
                            >
                        ...
                        <Link
                            href={item?.repolink}
                            key={item?.repolink}
                            className="flex px-[1.2rem] bg-[#010B0E] py-[0.5rem] rounded-lg" 
                            target="_blank">
